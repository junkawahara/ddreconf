 ...
 *
 * Copyright (c) 2018 -- 2020 Jun Kawahara
 *
...
public:
    ConnectedInducedSubgraphSpecMate(Offset hoc = 0)
            : hoc(hoc), nxt(0) {
    }
    ...
    ConnectedInducedSubgraphSpecMate& next() {
        return *(this + nxt);
    }

    ConnectedInducedSubgraphSpecMate const& next() const {
        return *(this + nxt);
    }
    ...
    void mergeLists(ConnectedInducedSubgraphSpecMate& o1, ConnectedInducedSubgraphSpecMate& o2,
    ...
    void replaceHeadWith(ConnectedInducedSubgraphSpecMate& newHead, ConnectedInducedSubgraphSpecMate* mate) const {
...
class ConnectedInducedSubgraphSpec: public tdzdd::PodArrayDdSpec<ConnectedInducedSubgraphSpec,
